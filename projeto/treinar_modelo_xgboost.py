...
def main():
    ...
    joblib.dump(model, "modelo_previsao.joblib")
    joblib.dump(scaler, "scaler_previsao.joblib")
    joblib.dump(["casa", "empate", "fora"], "classes_previsao.joblib")
    joblib.dump(X.columns.tolist(), "features_previsao.joblib")

    print("✅ Modelo salvo com sucesso em formato JOBLIB.")
